...
لو عندك محل، كافيه، أو أي مشروع …
وأكتر حاجة بتتعبك هي الحسابات، الديون، والمصاريف 😓
يبقى تطبيق **تحصيل** معمول علشانك 👌

التطبيق ببساطة بيساعدك تدير شغلك كله من الموبايل بسهولة جدًا ومن غير تعقيد 👇

🔹 أولاً: إدارة العملاء والديون
تقدر تضيف أي عميل عندك وتسجل عليه كل حاجة:
• اسم العميل (وممكن تختاره من جهات الاتصال)
• المنتج أو الخدمة
• المبلغ المدفوع
• والباقي عليه (الدين)

والتطبيق تلقائي بيحسب لك الباقي ويضيفه في الديون ✔️

وكمان:
• تقدر تسدد الدين كامل أو جزء منه
• تعرف كل عميل دفع كام وفاضل عليه كام
• تشوف كل العمليات اللي حصلت معاه بالتفصيل
• تعدل أو تحذف أي عملية بسهولة

🔹 مناسب جدًا لنظام الأقساط 💰
لو شغلك بيعتمد على التقسيط (زي محلات الموبايلات، الأجهزة، أو أي مشروع بيبيع بالتقسيط):
• تسجل إجمالي السعر
• تسجل المبلغ اللي العميل دفعه
• والباقي يتحسب تلقائي كدين

وكمان تقدر:
• تتابع كل دفعة دفعها العميل
• تشوف سجل كامل بكل الأقساط
• تبعت للعميل رسالة واتساب أو SMS بتفاصيل الدفع
يعني كل حاجة واضحة قدامك ومن غير لخبطة 🙏

🔹 الكافيهات والبلايستيشن 🎮☕
لو عندك كافيه أو بلايستيشن:
التطبيق بيوفر لك نظامين:
• حساب بالوقت (بالساعة)
• حساب بالدور (الماتش)

تدخل الوقت أو عدد الأدوار وهو يحسب لك الإجمالي تلقائي
ولو العميل دفع جزء… الباقي يتحول دين مباشرة ✔️

🔹 إدارة المصاريف 📊
تقدر تسجل كل مصاريفك:
• إيجار
• كهرباء
• مشتريات
• مرتبات
...
وتحدد التاريخ كمان، وكل شهر بيكون متقسم لوحده علشان تتابع بسهولة

🔹 ديوني أنا (الفلوس اللي عليك) 💡
مش بس بتتابع فلوسك عند الناس…
كمان تقدر تسجل كل الفلوس اللي عليك لأي حد 👇

• تضيف اسم الشخص أو المورد (وممكن من جهات الاتصال)
• تسجل إجمالي المبلغ اللي عليك
• تسجل اللي دفعته منه
• والباقي يتحسب تلقائي

وكمان:
• تقدر تدفع جزء أو تسدد بالكامل
• تتابع كل عملية دفعتها بالتاريخ
• تشوف سجل كامل بكل المدفوعات
• تبعت إشعار للشخص على واتساب أو SMS لما تدفع

يعني تبقى عارف أنت عليك كام… ودفعت كام… ومين فاضل له فلوس عندك 👌

🔹 التقارير والأرباح 📈
التطبيق بيديك تقارير واضحة جدًا:
• صافي الربح اليومي
• مقارنة بين النهاردة وامبارح
• مقارنة أسبوعية وشهرية
• إجمالي الدخل
• إجمالي المصاريف

يعني تعرف شغلك ماشي إزاي… بتكسب ولا بتخسر بكل وضوح 👍

🔹 مميزات مهمة جدًا 💡
• يشتغل من غير إنترنت
• أول ما الإنترنت يرجع البيانات بتتحدث تلقائي
• تقدر تستخدم نفس الحساب على أكتر من موبايل
• كل الأجهزة بتتحدث مع بعض في نفس الوقت
• يدعم عربي وإنجليزي
• فيه وضع ليلي (Dark Mode) مريح للعين

📌 التطبيق مناسب لـ:
✔️ أصحاب المحلات
✔️ الكافيهات
✔️ البلايستيشن
✔️ أي مشروع شغال بنظام الديون أو الأقساط

قال رسول الله ﷺ:
“رحم الله رجلا سمحا إذا باع، وإذا اشتــرى، وإذا اقتضـــى”
رواه البخاري 🤍
...
<table>
  <tr>
    <td><img src="https://github.com/user-attachments/assets/a3a4f924-ba02-403f-9581-e5d382da1c04" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/7a13a156-3a85-477d-b54b-797ef4e5c0f4" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/11a8f50d-018d-4f3e-a024-e9ea1d1e0cfa" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/86ca19ab-1cbc-4b28-9549-a61f90101995" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/0e00439c-c427-43c0-9aee-b90d07317e55" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/eb37989c-2626-486c-9b30-3e8f00df55e9" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/2edb7e54-1a5e-4463-a4c2-aefcf1b14483" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/1991d7fa-4fde-4caf-ab12-722c5b13aa53" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/93dc4365-6064-4574-87e8-f793fe6ac0ae" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/0e9d689a-0b37-4b36-a12a-a9039054c140" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/f71e7b47-1aa5-489a-83fe-fe103a084671" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/84213308-4d91-4079-8f5b-2af263cb6b64" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/2ba7e383-9e9e-41d7-84e9-65868ea77272" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/7118420e-c936-47d3-a3ee-5d706b069dd7" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/778dd47d-d0f1-4594-991c-7554723f8240" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/9b491c6c-809b-4297-82b1-e86ab439efb4" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/052ff96a-2bbf-4911-859f-bdd3fe5f8c33" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/52b7384c-43e4-4a92-a52a-80f9484d0d8d" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/b9cd8eef-77e5-4162-a891-9a10daf378e3" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/0b4959b3-f392-493a-803d-d57e982313ab" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/ba4eb4cb-33a6-4a89-b0b0-c994c713d07c" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/60a42027-82e6-4506-a69f-48369477ccb6" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/211ef570-f596-48c5-8209-b46bfe020bc9" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/3a883e66-968c-437f-9477-019b164cea2b" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/93229bb1-eada-4d0e-98ae-018e0876dc5c" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/df97f292-59fa-4af8-98db-45a945d91c87" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/82ca3645-3959-4e78-ab5a-840a0b6ace7a" width="200"/></td>
  </tr>

  <tr>
    <td><img src="https://github.com/user-attachments/assets/eb99594f-14be-423a-9f5e-a3140a79c8b2" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/8197cfeb-142b-40ee-81fb-80ebddb56de4" width="200"/></td>
    <td><img src="https://github.com/user-attachments/assets/9b4688aa-cdd9-4f95-9f41-6a4ebfbe1ea0" width="200"/></td>
  </tr>
</table>
...
# Tahsel (تحصيل) - Technical Reference Repo

This project serves as the codebase for **Tahsel** and also acts as a **standard repository for Abdullah Alawadi’s personal coding style**. It is a reusable base for future development, demonstrating a clean, maintainable, and scalable approach to building Flutter applications.

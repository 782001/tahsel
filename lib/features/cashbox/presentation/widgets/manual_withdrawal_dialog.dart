...
class ManualWithdrawalDialog extends StatefulWidget {
  final double currentBalance;
  final Function(double amount, String? note) onSubmit;

  const ManualWithdrawalDialog({
    super.key,
  ...
  @override
  State<ManualWithdrawalDialog> createState() => _ManualWithdrawalDialogState();
}

class _ManualWithdrawalDialogState extends State<ManualWithdrawalDialog> {
  ...
  void _submit() {
    ...
    if (amount > widget.currentBalance) {
      setState(() => _errorText = AppStrings.insufficientBalance.tr());
      return;
    }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${AppStrings.enterAmount.tr()} (${AppStrings.currentlyAvailableBalance.tr()} ${widget.currentBalance.toSmartAmount()} ${AppStrings.currencyEgp.tr()})',
                    style: TextStyles.customStyle(

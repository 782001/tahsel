...
import 'package:tahsel/features/settings/presentation/widgets/edit_profile_dialog.dart';
...
import 'package:tahsel/features/settings/presentation/widgets/profile_info_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<ProfileCubit>(
      create: (context) {
        ...
        return sl<ProfileCubit>()..loadProfile();
      },
                          ...
                          child: ConstrainedBox(
                            ...
                            child: ValueListenableBuilder<int>(
                              ...
                              builder: (context, _, child) {
                                final canViewCustomers = PermissionService
                                    .instance
                                    .hasPermission(
                                      AppPermissions.customersView,
                                    );
                                final canViewVault =
                                    ((!Platform.isIOS && isShop) ||
                                      ...
                                      children: [
                                        ...
                                        if (hasAnyBusinessTool)
                                          _buildCategoryGroupHeader(
                                            context: context,
                                            title: AppStrings.businessTools
                                                .tr(),
                                        ...
                                        if (PermissionService
                                          ...
                                          SectionHeader(
                                            title: AppStrings.changeCurrency
                                                .tr(),
                                          ),
                                          SizedBox(
                                          ...
                                          ValueListenableBuilder<
                                            CurrencyEntity
                                          >(
                                            valueListenable: CurrencyService
                                                .instance
                                                .currencyNotifier,
                                        ...
                                        if (!Platform.isIOS)
                                          SectionHeader(
                                            title: AppStrings.officialWebsite
                                                .tr(),
                                          ),

...
void main() {
  ...
  group('PsSessionRepositoryImpl Offline Tests', () {
    test(
      'startSession when online should save locally, queue record, and call syncSingleRecord',
      () async {
    ...
    test(
      'startSession when offline should save locally, queue record, but NOT call syncSingleRecord',
      () async {
    ...
    test(
      'endSession should delete session from local cache and queue ending record',
      () async {
        connectionChecker.isConnected = false;
    ...
    test(
      'getActiveSessions when offline should return locally started sessions that are not pending end',
      () async {
        connectionChecker.isConnected = false;
